...
## Vector Studios AI (este repositorio)

Antes de generar o refactorizar UI en `vector_studios_ia`, lee:

1. `.cursor/skills/design-taste-frontend/reference-vector.md`
2. `docs/MANUAL-DE-MARCA-VECTOR-STUDIOS.md`

La marca y el stack del proyecto **prevalecen** sobre defaults genéricos de este skill.
