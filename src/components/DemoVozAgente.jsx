  ...
  return (
    ...
    >
      <div className="mx-auto max-w-container-max px-margin-mobile py-24 md:px-margin-desktop md:py-28">
        ...
        <div className="gsap-reveal-stagger grid grid-cols-1 items-stretch gap-8 lg:grid-cols-[1fr_min(380px,36%)] lg:gap-10">
          <div className="gsap-reveal-item grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5">
            {demoVozPasos.map(({ id, n, titulo, texto }) => (
              <motion.article
                key={id}
              ...
              >
                <span className="font-mono-code mb-4 text-sm font-medium text-primary/75">{n}</span>
                <h3 className="font-headline-lg mb-2 text-lg text-primary-deep">{titulo}</h3>
          ...
          >
            <div className="relative z-[1]">
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary/25 bg-white/60 px-3 py-1.5">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-on-surface-variant md:text-body-md">
                Es una demo real del agente que configuramos para Vector Studios. Así escuchará tu marca cuando
                integremos voz en tu producto.
              </p>
            </div>
            ...
            <div className="convai-callout__pointer relative z-[1] mt-8 flex items-end justify-end gap-2">
              <p className="max-w-[10rem] text-right font-label-sm uppercase tracking-widest text-primary-deep">
                Mira abajo
                <span className="block text-secondary">a la derecha</span>
              </p>
              <motion.span
            ...
            <div className="convai-callout__glow pointer-events-none absolute -right-8 -top-8 h-40 w-40 rounded-full bg-primary/15 blur-3xl" aria-hidden="true" />
          </motion.aside>
        </div>
      </div>
    </ScrollZoomSection>
